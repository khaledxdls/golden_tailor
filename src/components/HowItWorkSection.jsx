function HowItWorkSection() {
  return (
    <div className="   gap-x-24 gap-y-32 text-lg items-center p-10 bg-primary-300 text-primary-50">
      <p className=" text-center font-bold text-4xl "> How it Work </p>{" "}
      <div className="flex justify-around items-center gap-7 p-8">
        <div className="w-1/2 ">
        ...
        <div className=" w-1/3 self-center">
          <img src="/howitwork1.jpg" className=" rounded-md" alt="calindar" />{" "}
        </div>{" "}
      </div>{" "}
      <div className="flex justify-between items-center gap-7 p-8">
        <div className=" w-1/3 self-center">
          <img src="/howitwork2.jpg" className=" rounded-md" alt="calindar" />{" "}
        </div>{" "}
        <div className="w-1/2 ">
          <h1 className="text-4xl mb-10 text-accent-400 font-medium">
            Sit Back and Relax{" "}
        ...
        <div className="w-1/2 ">
          ...
          <div className="space-y-8">
            <p>
              ...
              inform you of your garment ' s progress, from when we start
              working on it to when it 's ready for pickup or delivery. This
              way, you ' re always in the loop and can plan accordingly, making
              the entire process as convenient and stress - free as possible.{" "}
            </p>{" "}
          </div>{" "}
        </div>{" "}
        <div className=" w-1/3 ">
          <img src="/howitwork3.jpg" className=" rounded-md" alt="calindar" />{" "}
        </div>{" "}
      </div>{" "}
    </div>
  );
